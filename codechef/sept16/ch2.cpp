...
#include <algorithm>
using namespace std;
long long int a[501][501],rowsum[501]={0},ind=0,colsum[501];
int queue[505],mark[503]={0},n;
...
*/
	...
	cout<<endl;
	sort(queue,queue+ind);

	for(int i=0;i<ind;i++) printf("%d ",queue[i]);
	printf("\n");
